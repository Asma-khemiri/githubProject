    ...
    <div class="w-100">
        ...
        <form action="signup.php" method="post">
                <div class="d-flex gap-2 justify-content-center">
                    <img class="mb-4" src="images/logo.png" alt="" height="70">

                    <div>
                        <h1 class="h3 fw-normal my-1"><b>CV</b> Maker</h1>
                        <p class="m-0">Créez votre nouveau compte</p>
                ...
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingName" placeholder="Entre votre nom" name="nom">
                    <label for="floatingInput"><i class="bi bi-person"></i>Nom</label>
                </div>
                <div class="form-floating">
                    <input type="email" class="form-control" id="floatingEmail"placeholder="xyz@xyz.com" name="email" >
